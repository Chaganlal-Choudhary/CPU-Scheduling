This is a simple and interactive web project that helps you understand how different CPU scheduling algorithms work. It's built using only HTML, CSS, and JavaScript.
